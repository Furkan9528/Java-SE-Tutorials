...
public class Main {
	...
	public static void kayitAl() {
		...
		if(file.exists()) {
			System.out.println("Kaydedilmiş bir oyununuz var. Kayıttan devam etmek ister misiniz? (yes ya da no ) ");
	...
	private static void oyunTahtasi() {
		for (int i = 0 ;  i < 4 ; i++) {
